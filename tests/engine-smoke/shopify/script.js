...
// 1. Page Loaded
if (typeof document !== "undefined" && document.body && document.getElementById("shopify-section-header")) {
...
if (shopifyHeader) {
    ...
    el.id = "shopify-appended";
    el.textContent = "Shopify Storefront Initialized";
    shopifyHeader.appendChild(el);
    const checkEl = document.getElementById("shopify-appended");
    if (checkEl && checkEl.textContent === "Shopify Storefront Initialized") {
