...
// 1. Page Loaded
if (typeof document !== "undefined" && document.body && document.getElementById("app")) {
...
if (app) {
    ...
    el.id = "vue-appended";
    el.textContent = "Vue VNode Rendered";
    app.appendChild(el);
    const checkEl = document.getElementById("vue-appended");
    if (checkEl && checkEl.textContent === "Vue VNode Rendered") {
