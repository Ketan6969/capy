...
if (root) {
    ...
    el.id = "react-appended";
    el.textContent = "React Component Loaded";
    root.appendChild(el);
    const checkEl = document.getElementById("react-appended");
    if (checkEl && checkEl.textContent === "React Component Loaded") {
