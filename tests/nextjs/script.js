...
// 1. Page Loaded
if (typeof document !== "undefined" && document.body && document.getElementById("__next")) {
...
if (nextRoot) {
    ...
    el.id = "next-appended";
    el.textContent = "NextJS Page Hydrated";
    nextRoot.appendChild(el);
    const checkEl = document.getElementById("next-appended");
    if (checkEl && checkEl.textContent === "NextJS Page Hydrated") {
